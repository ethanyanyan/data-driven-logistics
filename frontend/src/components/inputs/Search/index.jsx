 ...
 */
function Search({ name, placeholder, data=[], titles=[], searchFn=s.caseInsensitiveAlphabetical}) {
 ...
 */
function SearchResults({height=0, isFocused, filteredList, name, titles, handleResultClicked}) {
