...
test("maxLength", () => {
  ...
  const testCases = [
    ...
    { input: "Hello world", expected: { isValid: true, errorMsg: null } },
    {
      input: "Hello world this is a new day",
      expected: {
        isValid: false,
...
test("startsCapital", () => {
  const testCases = [
    {
      input: "",
      expected: { isValid: false, errorMsg: "Must start with capital letter" },
    },
    {
      input: "hello",
      expected: { isValid: false, errorMsg: "Must start with capital letter" },
...
test("alphaNumericOnly", () => {
  const testCases = [
    {
      input: "",
      expected: { isValid: false, errorMsg: "Alphanumeric characters only" },
    },
    {
      input: " ",
      expected: { isValid: false, errorMsg: "Alphanumeric characters only" },
...
test("matchesTarget", () => {
  const testCases = [
    ...
    {
      inputs: ["hi", "Hi"],
      expected: { isValid: false, errorMsg: "Does not match" },
    },
    {
      inputs: ["hello ", "hello "],
      expected: { isValid: true, errorMsg: null },
    },
  ];
...
test("matchesOneInList", () => {
  const testCases = [
    ...
    {
      inputs: ["hi", ["Hi", "bye", "hI"]],
      expected: { isValid: false, errorMsg: "Must match value in list" },
    },
    {
      inputs: ["hello124 ", ["hello124"]],
      expected: { isValid: false, errorMsg: "Must match value in list" },
    },
  ];
